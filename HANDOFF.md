...
6. **Charades** — **one loop, two decks** (reshaped 2026-09-10). *Classic* deals from `games_data.json`: Hollywood (200) / Bollywood (200) / mix_movies extras (37) / Everyday Actions (60) / Around the House (45) / The Zoo (46) / family_mix extras (40) — seven **storage** arrays the game unions into four player-facing decks, so Movie Mix deals 437 and Family Mix 191. *One Clue* deals from `src/data/charades_clues.json`: Hollywood (197), Bollywood (180), Everything Else (292), plus Movie Mix (the two movie packs combined at deal time, 377). Both decks play the identical card → Correct/Skip → next card loop.
