...
| **4 — Premium image** ✅ | Style gallery w/ baked thumbnails · Flash-Image default + Pro premium tier · rationing + server-side limits · reveal animation | **M** | Image spend drops ~70% and becomes bounded. *Shipped with two deviations — emoji tiles instead of baked thumbnails; rationing client-side only (server-side limit still open, needs a store).* |
