...
> **Last reconciled with code:** 2026-08-16 (added `src/components/ui/SpinTheBottle.tsx` — the shared "who goes next?" decider — plus a `BOTTLE` test screen inside Truth or Drink. Not yet wired into any game's turn logic; see the shared-modules note below). If you're reading this and something in the codebase doesn't match what's described here, **the code is the source of truth** — please update this file in the same PR that makes the change.
>
