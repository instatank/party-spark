...
> **Last reconciled with code:** 2026-07-06 (share cards redesigned — tagline/context/challenge fields + CTA band with the app link; Home gained a gold-glow "Today's Pick" tile, date-seeded, below the quick-action row). If you're reading this and something in the codebase doesn't match what's described here, **the code is the source of truth** — please update this file in the same PR that makes the change.
>
